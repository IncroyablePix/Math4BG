...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Basic"))
    {
        ...
        // Background buttons, demonstrate using PushID() to add unique identifier in the ID stack, and changing style.
        for (int i = 0; i < 7; i++)
        {
            if (i > 0)
                ImGui::SameLine();
    ...
    if (ImGui::TreeNode("Background/Picker Widgets"))
    {
        ...
        ImGui::Text("Background widget:");
        ImGui::SameLine(); HelpMarker(
            "Click on the color square to open a color picker.\n"
            "CTRL+click on individual component to input value.\n");
        ImGui::ColorEdit3("MyColor##1", (float*)&color, misc_flags);

        ImGui::Text("Background widget HSV with Alpha:");
        ImGui::ColorEdit4("MyColor##2", (float*)&color, ImGuiColorEditFlags_DisplayHSV | misc_flags);

        ImGui::Text("Background widget with Float Display:");
        ImGui::ColorEdit4("MyColor##2f", (float*)&color, ImGuiColorEditFlags_Float | misc_flags);

        ImGui::Text("Background button with Picker:");
        ImGui::SameLine(); HelpMarker(
        ...
        ImGui::Text("Background button with Custom Picker Popup:");
        ...
        ImGui::Text("Background button only:");
        static bool no_border = false;
        ImGui::Checkbox("ImGuiColorEditFlags_NoBorder", &no_border);
        ImGui::ColorButton("MyColor##3c", *(ImVec4*)&color, misc_flags | (no_border ? ImGuiColorEditFlags_NoBorder : 0), ImVec2(80, 80));

        ImGui::Text("Background picker:");
        ...
        {
            ImGui::SameLine();
            ImGui::Checkbox("With Ref Background", &ref_color);
            if (ref_color)
            {
                ImGui::SameLine();
        ...
        ImGui::Text("Background widget with InputHSV:");
    ...
    if (ImGui::TreeNode("Drag and Drop"))
    {
        if (ImGui::TreeNode("Drag and drop in standard widgets"))
        {
            ...
            // Also see 'Demo->Widgets->Background/Picker Widgets->Palette' demo.
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    if (ImGui::BeginTabBar("##TabBar"))
    {
        if (ImGui::BeginTabItem("Primitives"))
        {
            ...
            ImGui::ColorEdit4("Background", &colf.x);
