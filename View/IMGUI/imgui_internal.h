...
struct IMGUI_API ImGuiWindow
{
    ...
    ImS8                    HiddenFramesCanSkipItems;           // Pause the window for N frames
    ImS8                    HiddenFramesCannotSkipItems;        // Pause the window for N frames while allowing items to be submitted so we can measure their size
    ImS8                    HiddenFramesForRenderOnly;          // Pause the window until frame N at Render() time only
