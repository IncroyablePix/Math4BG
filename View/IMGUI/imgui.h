...
namespace ImGui
{
    ...
    // Widgets: Background Editor/Picker (tip: the ColorEdit* functions have a little color square that can be left-clicked to open a picker, and right-clicked to open an option menu.)
...
enum ImGuiTableColumnFlags_
{
    ...
    ImGuiTableColumnFlags_IsEnabled             = 1 << 24,  // Status: is enabled == not hidden by user/api (referred to as "Pause" in _DefaultHide and _NoHide) flags.
